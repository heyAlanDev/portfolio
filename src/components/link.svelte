...
<a
  id={$$props.id}
  href={to}
  class="capitalize select-none cursor-pointer text-[--anchor-color] hover:text-[--text-hover-color] active:text-[--text-hover-color]
    {as === 'button' &&
    'px-6 py-2 text-center font-bold rounded-full border-2 border-[--anchor-color] hover:bg-[--anchor-color] hover:border-[--anchor-color] active:bg-[--anchor-color] active:border-[--anchor-color]'}
